...
#     '''Testing if it is possible to access create course page when you don't have permissions '''
#     client = Client()
#     client.force_login(user=user)
...
#     '''Testing if it is possible to  access create course page when you have permissions '''
...
#     '''Testing if it is possible to access delete course page when you don't have permissions '''
#     client = Client()
#     client.force_login(user=user)
...
#     '''Testing if it is possible to delete course when you have permissions '''
#     user.is_teacher = True
...
#
#
# def test_deleting_course_teacher_post(user, course):
#     """Testing if it is possible to delete course"""
#     client = Client()
#     client.force_login(user=user)
#     user.is_teacher = True
#     p1 = Permission.objects.get(codename="delete_course")
...
#     course.owner = user
#     course.save()
#     response = client.post(reverse('courses:deletecourse', kwargs={'pk': course.id}))
#     courses = Course.objects.filter(owner=user)
#     assert len(courses) == 0
#
#
# def test_editing_course_view(user, course):
#     """Testing if it is possible to access edit course page when you don't have permissions """
#     client = Client()
#     client.force_login(user=user)
...
#     """Testing if it is possible to access edit course page when you have permissions """
#     user.is_teacher = True
...
#     """Testing if it is possible to access adding students to course page when you don't have permissions"""
#     client = Client()
#     client.force_login(user=user)
...
#     """Testing if it is possible to access adding students to course page when you have permissions """
#     user.is_teacher = True
#     p1 = Permission.objects.get(codename="change_course")
#     user.user_permissions.add(p1)
#     client = Client()
